...
<head>
    ...
    <link media="all" rel="stylesheet" href="../css/bootstrapHomepage/all.css">
    ...
    <!--[if lt IE 9]><link rel="stylesheet" href="../css/bootstrapHomepage/ie.css" media="screen" /><![endif]-->
...
<div class="search-panel">
    <div class="container-fluid">
        <div class="head-holder">
            <h2>SEARCH BARD</h2>
            <p>Search assay, project and experiment data or <a href="#">learn about BARD’s innovative search features.</a></p>
        </div>
        <div class="search-block">
            <form action="#" class="search-form">
                <fieldset>
                    <div class="search-field">
                        ...
                        <div class="btn-field">
                            <button class="btn btn-primary" type="submit">Search <span class="hidden-phone">BARD</span></button>
                        </div>
                    </div>
                </fieldset>
            </form>
            <div class="links-holder">
                ...
                <a href="#" class="download-link">Download the BARD Desktop Client</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="news-row">
            ...
            <div class="news-holder">
                <div class="news-gallery slide" id="news-gallery" data-interval="false">
                    ...
                    <a href="#news-gallery" class="btn-next" data-slide="next">Previous</a>
                    <div class="carousel-inner">
                        <div class="item active">
                            <strong class="ttl">Webcast <time datetime="2013-08-16T08:20">AUG 16 2013 @ 8:20 pm</time> </strong> <p><a href="#">Nullam dapibus orci at turpis molestie porttitor quis eu odio.</a></p>
                        </div>
                        <div class="item">
                            <strong class="ttl">Webcast <time datetime="2013-08-17T08:20">AUG 17 2013 @ 8:20 pm</time> </strong> <p><a href="#">2 Nullam dapibus orci at turpis molestie porttitor quis eu odio.</a></p>
                        </div>
                        <div class="item">
                            <strong class="ttl">Webcast <time datetime="2013-08-18T08:20">AUG 18 2013 @ 8:20 pm</time> </strong> <p><a href="#">3 Nullam dapibus orci at turpis molestie porttitor quis eu odio.</a></p>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="articles-gallery slide" id="articles-gallery" data-interval="false">
    ...
    <a href="#articles-gallery" class="btn-next" data-slide="next">Previous</a>
    <div class="carousel-inner">
            ...
            <div class="item active">
                <div class="row-fluid">
                    <article class="span4">
                        ...
                        <h2><a href="#">Universal chemical assay for the detection and determination of siderophores.</a></h2>
