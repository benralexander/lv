...
(function () {
    ...
    cbbo.slider = function (domainStart,
                            domainEnd,
                            rangeStart,
                            rangeEnd,
        ...
        var brush,
            ...
            brushed = function () {
                ...
                if (d3.event === null) { // this happens only if brushed is called programmatically with no event
                    ...
                    if (orientation === 'horizontal') {
                        ...
                        handle.attr("cy", scale(initialSliderValue));
                    }
            ...
            ctor = function (domainStart, domainEnd, rangeStart, rangeEnd) {
                var svg,
                    slider,
                    previouslyExistingSlider = d3.select('#slider').selectAll("svg");
                ...
                if (previouslyExistingSlider) {
                    previouslyExistingSlider.remove();
                }
        ...
        // Ever definitions are finished. It's time to do actually build the slider.
